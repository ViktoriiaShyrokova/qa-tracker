...
public class TestCase {
    ...
    // Поля: private — нельзя обратиться снаружи напрямую (тема занятия 2)
    private int    id;
    private String title;       // название теста
    private String status;      // текущий статус: PENDING/PASSED/FAILED/BLOCKED
    private String priority;    // приоритет: LOW/MEDIUM/HIGH/CRITICAL
    private String assignedTo;  // кому назначен
